...
import com.plcoding.echojournal.core.presentation.desingsystem.buttons.PrimaryButton
import com.plcoding.echojournal.core.presentation.desingsystem.buttons.SecondaryButton
import com.plcoding.echojournal.core.presentation.desingsystem.text_fields.TransparentHintTextField
import com.plcoding.echojournal.core.presentation.desingsystem.theme.EchoJournalTheme
import com.plcoding.echojournal.core.presentation.desingsystem.theme.secondary70
import com.plcoding.echojournal.core.presentation.desingsystem.theme.secondary95
    ...
    Scaffold(
        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { onAction(CreateEchoAction.OnNavigateBackClick) }) {
                        Icon(
        ...
        Column(
            ...
            EchoTopicsRow(
                ...
                showTopicSuggestions = state.shopTopicSuggestion,
        ...
        if (state.showMoodSelector) {
            SelectMoodSheet(
                ...
                onConfirmClick = { onAction(CreateEchoAction.OnConfirmMoodClick) }
            )
        }
        if (state.showConfirmLeaveDialog) {
            AlertDialog(
                onDismissRequest = { onAction(CreateEchoAction.OnDismissConfirmLeaveDialog) },
                confirmButton = {
                    TextButton(
