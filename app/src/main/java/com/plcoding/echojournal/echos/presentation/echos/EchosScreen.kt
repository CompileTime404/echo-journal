...
import com.plcoding.echojournal.core.presentation.desingsystem.theme.bgGradient
...
fun EchosRoot(
    ...
    val permissionLauncher = rememberLauncherForActivityResult(
        ...
        if (isGranted && state.currentCaptureMethod != null) {
...
fun EchosScreen(
    ...
    val context = LocalContext.current
    var awaitingQuickPermission by remember {
            ...
            EchoQuickRecordFloatingActionButton(
                ...
                onLongPressStart = {
                    ...
                    if (hasPermission) {
                        ...
                        awaitingQuickPermission = true
                        onAction(EchosAction.OnRequestPermissionQuickRecording)
                    }
                },
                onLongPressEnd = { isCancelled ->
                    if (awaitingQuickPermission) {
                        awaitingQuickPermission = false
                        return@EchoQuickRecordFloatingActionButton
                    }
                    if (isCancelled) {
